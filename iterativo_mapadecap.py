...
while endereco != 'sair':  
  ...
  #driver = webdriver.Chrome(PATH) ##legacy - era necessario enviar o caminho anteriormente - o Selenium passou a gerenciar automaticamente o webdriver baixando e utilizando o correto
